  ...
  return (
    <div className="relative">
      ...
      {isPopupOpen && (
        ...
        >
          {/* User Info */}
          <div className="flex w-full items-center gap-3 p-4 border-b border-gray-200 bg-gradient-to-r from-[var(--primary-color)] to-[#df7904] text-white rounded-t-lg">
            <div
          ...
          <div className="p-4">
            <NavLink to={'/orders'}
              className="flex items-center gap-3 w-full text-gray-700 py-2 px-3 rounded-lg hover:bg-gray-100"
            >
